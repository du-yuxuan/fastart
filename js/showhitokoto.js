function startHitokoto() {
    document.getElementById("hitokoto").style.bottom = "95px";
    setTimeout('document.getElementById("hitokoto").style.bottom = "80px";', 1000);

    var xhr = new XMLHttpRequest();
    xhr.open('get', 'https://v1.hitokoto.cn?c=d&c=e&c=i&c=j&c=k&max_length=15&min_length=13');
